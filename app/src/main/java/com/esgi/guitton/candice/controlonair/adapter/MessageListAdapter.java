    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_MESSAGE_SENT) {
            view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.sent_content_message, parent, false);
            return new SentMessageHolder(view);
        } else if (viewType == VIEW_TYPE_MESSAGE_RECEIVED) {
            view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.received_content_message, parent, false);
    ...
    private class ReceivedMessageHolder extends RecyclerView.ViewHolder {
        ...
        void bind(Message message) {
          ...
          //  timeText.setText(Utils.formatDateTime(message.getTimestamp()));
            ...
            //Utils.displayRoundImageFromUrl(mContext, message.getAuthor().getProfileUrl(), profileImage);
        }
    }
}
